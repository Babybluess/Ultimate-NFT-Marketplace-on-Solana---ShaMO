         ...
         <div className="rounded-lg border bg-card text-card-foreground shadow-sm w-full mx-auto md:max-w-lg">
            ...
            <div className="p-6 pt-0 flex flex-row space-x-2 relative">
               ...
               <div className={` ${isOpen == true ? " grid" : " hidden"}  w-28 h-28 rounded-lg bg-[#09090B] border-[1px] p-2 border-white grid-cols-2 gap-2 absolute top-12 right-5 justify-center items-center`}>
                  ...
                  <div onClick={() => getAmount(1.0)} className=" w-full h-full cursor-pointer bg-[#09090B] border-[1px] border-white rounded-lg hover:bg-[#494159] text-white justify-center items-center flex">
                  ...
                  <div onClick={() => getAmount(5.0)}  className=" w-full h-full cursor-pointer bg-[#09090B] border-[1px] border-white rounded-lg hover:bg-[#494159] text-white justify-center items-center flex">
