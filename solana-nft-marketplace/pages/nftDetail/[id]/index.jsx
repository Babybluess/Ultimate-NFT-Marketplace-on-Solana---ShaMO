...
function index() {
   ...
   const borrow = (nftAddress) => {
      // const date = new Date();
      // date.setDate(date.getDate() + Number(timeBorrow));
      // const expiration = `${date.getDay()}/${
      //    date.getMonth() + 1
      // }/${date.getFullYear()}-${date.getHours()}:${date.getMinutes()}`;

      // borrowNFT(Network.Devnet, nftAdress, price, lender, publicKey.toBase58());
      // repayment(Network.Devnet, publicKey.toBase58(), lender, Number(process.env.NEXT_PUBLIC_STAKE_VALUE))
